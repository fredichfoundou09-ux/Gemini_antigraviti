...
const MENU: MenuItem[] = [
  ...
  { to: "/app/devoirs", label: "Devoirs & Remises", icon: <ClipboardCheck size={18} />, roles: ["superadmin", "admin", "teacher"] },
  { to: "/app/tests", label: "Tests & Évaluations", icon: <TestTube2 size={18} />, roles: ["superadmin", "admin", "teacher"] },
  ...
  { to: "/app/mes-evaluations", label: "Mes évaluations", icon: <TestTube2 size={18} />, roles: ["student"] },
