      ...
      try {
        ...
        setDb((prev) => ({
          ...
          tests: (testsRes.data || []).map((t: any) => ({
            ...
            chapitreId: t.chapitre_id || undefined,
            ...
            seuilReussite: Number(t.seuil_reussite || 10),
            dateDebut: t.date_debut,
            dateFin: t.date_fin,
            difficulte: t.difficulte,
            tentatives: t.tentatives,
            afficherCorrections: t.afficher_corrections,
            validationRequise: t.validation_requise,
            statut: t.statut || "publie",
            audience: t.audience || "module",
            targetGroupe: t.target_groupe,
            targetStudentIds: t.target_student_ids || [],
            modeSecurise: Boolean(t.mode_securise),
            bloquerCopierColler: t.bloquer_copier_coller !== false,
            bloquerClicDroit: Boolean(t.bloquer_clic_droit),
            navigationLibre: t.navigation_libre !== false,
